...
-(void)fetchObjectOnPage:(NSUInteger)page refresh:(BOOL)refresh
{
    [_manager GET:self.generateURL(page) parameters:nil success:^(NSURLSessionDataTask *task, id responseObject) {
